...
@section('content')
    <video  src="/video/RocketGuard SelfHealing_2 (online-video-cutter.com)_2_2_2.mp4" autoplay muted loop id="myVideo"></video>
                    ...
                    <div class="row-form-box">
                        ...
                        <div role="form" class="wpcf7" id="wpcf7-f121-o1" lang="ru-RU" dir="ltr">
                            ...
                            <form action="/#wpcf7-f121-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                                ...
                                <p>
                                    <input type="submit" value="KONTAKT ANFORDERN"
